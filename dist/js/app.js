(() => {
    ...
    function initSliders() {
        ...
        if (programTemplates.length > 0) programTemplates.forEach((programTemplate => {
        ...
        if (document.querySelector(".firstscreen__slider")) {
            new swiper_core_Swiper(".firstscreen__slider", {
        ...
        if (document.querySelector(".events-upcoming__slider") && window.innerWidth <= 991.98) new swiper_core_Swiper(".events-upcoming__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.4,
        ...
        if (document.querySelector(".features__slider")) new swiper_core_Swiper(".features__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.25,
        ...
        if (document.querySelector(".career__slider")) new swiper_core_Swiper(".career__slider", {
        ...
        if (document.querySelector(".direction__slider")) new swiper_core_Swiper(".direction__slider", {
            modules: [ Pagination, Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.3,
    ...
    document.addEventListener("click", (function(e) {
        ...
        if (!targetElement.closest(".language") && document.querySelectorAll(".language._hover").length > 0) removeClasses(document.querySelectorAll(".language._hover"), "_hover");
        if (window.innerWidth > 767.98) {
            ...
            if (!targetElement.closest(".menu__item_has-children") && document.querySelectorAll(".menu__item_has-children._hover").length > 0) removeClasses(document.querySelectorAll(".menu__item_has-children._hover"), "_hover");
            ...
            if (!targetElement.closest(".menu__subitem_has-children") && document.querySelectorAll(".menu__subitem_has-children._hover").length > 0) removeClasses(document.querySelectorAll(".menu__subitem_has-children._hover"), "_hover");
        }
        if (targetElement.closest(".menu-var__item>a")) {
            ...
            } else if (!parent.classList.contains("_active")) {
        ...
        if (targetElement.closest(".menu__back") && window.innerWidth < 767.98) targetElement.closest(".menu__item").classList.remove("_active");
        if (targetElement.closest(".menu__arrow_main") && window.innerWidth < 767.98) targetElement.closest(".menu__item").classList.add("_active");
    ...
    if (menuSublist.length > 0 && window.innerWidth < 767.98) menuSublist.forEach((sublist => {
        _slideUp(sublist);
    }));
    ...
    if (filters.length > 0) filters.forEach((element => {
        element.addEventListener("change", (function() {
            const parent = element.closest(".level-filter");
            let parentCategory = parent.dataset.category;
            if (parentCategory) items.forEach((item => {
                let itemDataValue = item.dataset.category;
                if (itemDataValue === parentCategory) item.style.display = "grid"; else item.style.display = "none";
    ...
    if (hasChildren.length > 0) hasChildren.forEach((element => {
    ...
    window.addEventListener("DOMContentLoaded", (function() {
        setTimeout((() => {
            ...
            if (eventsCards.length > 0 && !isMobile.any()) updateEvents(eventsCards);
        }), 500);
    }));
